...
def extract_method_videos(data_path, output_path, dataset, compression):
    ...
    if output_path is None:
        ...
        images_path = join(output_path, 'Real')
    else:
        images_path = join(output_path, 'Fake')
...
if __name__ == '__main__':
    ...
    p.add_argument('--data_path', type=str, default='..\dataset\input')
    p.add_argument('--output_path', type=str, default='..\dataset\output')
